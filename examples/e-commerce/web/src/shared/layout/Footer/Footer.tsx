  ...
  return (
    <footer className={styles.footer}>
      <div className={`container ${styles.grid}`}>
        ...
        <div className={styles.col}>
          <h4>{t("categories")}</h4>
          <a href={localePath(locale, `${ROUTES.CATEGORY}/all`)}>{t("allProducts")}</a>
          <a href={localePath(locale, `${ROUTES.CATEGORY}/elektronik`)}>Elektronik</a>
          <a href={localePath(locale, `${ROUTES.CATEGORY}/moda`)}>Moda</a>
          <a href={localePath(locale, `${ROUTES.CATEGORY}/dogal-tas-bileklik`)}>Doğal Taş</a>
        </div>
        <div className={styles.col}>
          <h4>{t("corporate")}</h4>
