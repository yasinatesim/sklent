...
import { placeOrder } from "@/features/web/orders/api/orders";

import CardPreview from "@/features/web/checkout/components/CardPreview";
...
const PaymentStep = ({ email }: PaymentStepProps) => {
  ...
  const handlePayClick = async () => {
    ...
    clear();
    router.push(localePath(locale, ROUTES.CHECKOUT_SUCCESS) + `?order=${data.orderId}&amount=${total}`);
  };
